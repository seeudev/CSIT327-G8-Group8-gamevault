...
SECRET_KEY = 'django-insecure-zf4(x91kp(kqul1zos2smnu%y)s@bh9w5jk&s%2u*smvjy%zvy'
...
INSTALLED_APPS = [
    ...
    # 'corsheaders',  # Not needed for vanilla HTML
    'users',
    'store'
]

MIDDLEWARE = [
    # 'corsheaders.middleware.CorsMiddleware',  # Not needed for vanilla HTML
...
# CORS Configuration for development (no longer needed for vanilla HTML)
